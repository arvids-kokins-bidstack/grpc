...
class ChannelArguments {
 public:
  ...
  void SetSslTargetNameOverride(const grpc::rtstring& name);
  ...
  void SetUserAgentPrefix(const grpc::rtstring& user_agent_prefix);
  ...
  void SetLoadBalancingPolicyName(const grpc::rtstring& lb_policy_name);

  /// Set service config in JSON form.
  /// Primarily meant for use in unit tests.
  void SetServiceConfigJSON(const grpc::rtstring& service_config_json);

  // Generic channel argument setters. Only for advanced use cases.
  /// Set an integer argument \a value under \a key.
  void SetInt(const grpc::rtstring& key, int value);
  ...
  void SetPointer(const grpc::rtstring& key, void* value);

  void SetPointerWithVtable(const grpc::rtstring& key, void* value,
                            const grpc_arg_pointer_vtable* vtable);

  /// Set a textual argument \a value under \a key.
  void SetString(const grpc::rtstring& key, const grpc::rtstring& value);
