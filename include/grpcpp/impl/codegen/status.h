...
class Status {
 public:
  ...
  Status(StatusCode code, const grpc::rtstring& error_message)
  ...
  Status(StatusCode code, const grpc::rtstring& error_message,
         const grpc::rtstring& error_details)
      : code_(code),
  ...
  grpc::rtstring error_message() const { return error_message_; }
  /// Return the (binary) error details.
  // Usually it contains a serialized google.rpc.Status proto.
  grpc::rtstring error_details() const { return binary_error_details_; }
 ...
 private:
  StatusCode code_;
  grpc::rtstring error_message_;
  grpc::rtstring binary_error_details_;
};
